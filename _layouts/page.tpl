...
<aside>
	<h2><a href="/">{{ site.name }}</a><a href="/feed.xml" class="feed-link" title="Subscribe"><img src="https://lh5.googleusercontent.com/-A-Mwr1eJKzM/UoRtqyTdTQI/AAAAAAAABO0/WrTRmH6gqz0/s64-no/feed-alt.png" alt="RSS feed" /></a></h2>
	<nav class="block">
		<ul>
